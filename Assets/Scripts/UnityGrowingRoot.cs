...
namespace Roots
{
    ...
    public class UnityGrowingRoot : MonoBehaviour
    {
        ...
        private void Contort(float alpha)
        {
            ...
            // {
            //     float nodeDistanceRate = nodeDistance / spline.GetLength();
            //     float nodeScale = startScale * (alpha - nodeDistanceRate);
            //     scales.Add(new Vector2(nodeScale, nodeScale));
            //     
            //     nodeDistance += spline.GetCurveLength(i);
            // }
